...
<header class="desktop header axil-header header-style-5">
    ...
    <div class="axil-mainmenu" style="background: #ffffff;">
                    ...
                    <form action="{{ route('front.products.index')}}">
                        <div class="header-top-dropdown dropdown-box-style">
                            ...
                            <div class="axil-search">
                                ...
                                <input type="search" class="placeholder product-search-input" name="q" id="search2"
                                       value="{{ request('q')??''}}" maxlength="128"
                                       placeholder="প্রোডাক্ট খুজুন এখানে..." autocomplete="off">
                            </div>
                ...
                <div class="col-2">
                    <div class="header-action">
                        <ul class="action-list">
                                ...
                                <a href="{{ route('front.carts.index')}}?segment={{request()->segment(1)}}"
                                   class="cart-dropdown-btn">
                                    <span class="cart-count"
                                          style="background: #7393f2 !important;">{{ getTotalCart()}}</span>
                            ...
                            @auth
                            <li class="">
                                <a href="{{ route('front.dashboard.index') }}" class="">
        ...
        <div class="desktopnav container-fluid"
             style="border-bottom: 1px solid #f2f2f2;background-color:red;color:white">
        </div>
                ...
                <div class="col-2">
                    <div class="header-action">
                        ...
                        <li>
                            <a href="{{ route('front.carts.index')}}?segment={{request()->segment(1)}}"
                               class="cart-dropdown-btn">
                                <img src="https://www.pallibazarbd.com/categories/cart1696507114.png" alt="cart"
                                     style="width:30px;">
                            </a>
                        </li>
        ...
        <div class="mobilesearch col-12">
            <div class="header-top-dropdown dropdown-box-style">
                <div class="axil-search">
                    ...
                    <input type="search" class="placeholder product-search-input" name="q" id="search2"
                           value="{{ request('q') ??''}}" maxlength="128" placeholder="Search in ITpratidin"
                           autocomplete="off">
                </div>
            </div>
        </div>
