                    ...
                    <ul class="cart-action col-12">
                        <li class="select-option col-12" style="margin-bottom: 0px;">
                            <button type="submit" class="btn p-0 m-auto text-light col-12"
                                    style="background: #fca204 !important;">
            ...
            <div class="product-add-to-cart">
                <ul class="cart-action">
                    <li class="col-12 reg" style="background: #fca204; padding: 7px;border-radius: 4px;">
                        <a type="submit" style="color:white;font-size: 13px;font-weight: 900;"
                           href="{{ route('front.products.show',[$product->id])}}"><i class="fas fa-shopping-cart"></i>
                            &nbsp; {{ $bangla_text->order_text }} </a>
                    </li>
                </ul>
            </div>
        </div>
