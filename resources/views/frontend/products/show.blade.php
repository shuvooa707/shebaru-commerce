                            ...
                            <div class="col-lg-10 order-lg-2">
                                <div class="single-product-thumbnail-wrap zoom-gallery">
                                    ...
                                    <div class="label-block">
                                        <div class="product-badget" style="background: #fc5403;">{{$product->discount_type=='fixed'?'Tk :':''}}{{$product->discount}} {{$product->discount_type=='fixed'?'':'%'}} OFF</div>
                                    </div>
                                  	@endif
                            ...
                            <div class="inner" style="color:#000">
                                ...
                                <div class="product-meta">
                                      ...
                                      <div class="product-price-variant">
                                        ...
                                        @if($product->discount_type)
                                        <span class="price old-price" style="font-size:16px;margin-left:12px;background: #fc5403;padding:4px;color:#fff">{{$product->discount}} {{$product->discount_type=='fixed'?'Tk':'%'}} OFF </span>
                                        @endif
                                      </div>
                                  	</div>
                                    ...
                                    <div class="product-action-wrapper d-flex-center" style="margin-bottom: 15px;">
                                        ...
                                        <ul class="product-action d-flex-center mb--0" style="margin-left: 22px;">
                                            <li class="add-to-cart" style="margin: 0px;">
                                                ...
                                                <button class="axil-btn" style="padding:7px 28px; background: #fca204; width: 235px;color: white;">{{ $bangla_text->order_text }}</button>
                                                 
                                                @else
                                                <button class="axil-btn" style="padding:7px 28px; background: #fca204; width: 235px;color: white;">{{ $bangla_text->fshipping_text }} {{ $bangla_text->order_text }} </button>
                                                @endif
                                            </li>
                    ...
                    <div class="product-add-to-cart col-12">
                        <ul class="cart-action col-12" style="padding-left: 0px;width: 100%;">
                            <li class="select-option col-12" style="margin-bottom: 0px;">
                                ...
                                <button type="submit" class="btn p-0 m-auto text-light col-12" style="background: #fc5403 !important;"> 
