            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active br_manage">Vendor Manage</li>
                    </ol>
                </div>
                    ...
                    <div class="col-sm-12 mb-2">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="col-auto">
                                    <a class=" btn btn-sm btn-info top_update"
                                       href="{{ route('admin.topBrandUpdate')}}?is_top=1">Active Top Brand</a>
                                    <a class=" btn btn-sm btn-danger top_update"
                                       href="{{ route('admin.topBrandUpdate')}}?is_top=0">De-active Top Brand</a>
                                </div>
                            </div>
                            ...
                            <table class="table table-centered mb-0">
                                    ...
                                    <th>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input check_all" value="">Check
                                                All
                                            </label>
                                        </div>
                                    </th>
                                ...
                                @foreach($items as $key=> $item)
                                    <tr>
                                        ...
                                        <td>
                                            @can('type.edit')
                                                <a href="{{ route('admin.types.edit',[$item->id])}}"
                                                   class="action-icon btn_modal">
                                                    <i class="mdi mdi-square-edit-outline"></i>
                                                </a>
                                            @endcan
                                            @can('type.delete')
                                                <a href="{{ route('admin.types.destroy',[$item->id])}}"
